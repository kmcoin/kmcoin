#############################################################################
# Makefile for building: KMC-Qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: ?? ?? 22 15:39:43 2016
# Project:  KMC_pos-windows.pro
# Template: app
# Command: c:/Qt/4.8.6/bin/qmake.exe USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile KMC_pos-windows.pro
#############################################################################
...
Makefile: KMC_pos-windows.pro  c:/Qt/4.8.6/mkspecs/default/qmake.conf c:/Qt/4.8.6/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile KMC_pos-windows.pro
