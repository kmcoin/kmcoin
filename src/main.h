...
static const int COINBASE_MATURITY_PPC = 500; // Adapted for kmc - same as it is set in Bitcoin, where KMC is 500
// Threshold for nLockTime: below this value it is interpreted as block number, otherwise as UNIX timestamp.
static const int LOCKTIME_THRESHOLD = 500000000; // Tue Nov  5 00:53:20 1985 UTC
static const int STAKE_TARGET_SPACING = 60*1; // kmc: 30 minute block spacing
static const int STAKE_MIN_AGE = 60 * 60 * 8; // kmc: Minimum age for coin age changed to 3 days
static const int STAKE_MAX_AGE = 60 * 60 * 24 * 90; // kmc: Stake age of full weight
static const int64 IPO_SHARES = 50000000000 * COIN; // kmc: Total number of shares to create using proof of work (intented for IPO)
static const int64 PROOF_OF_WORK_BLOCKS = 2500; // kmc: Block height of the last proof of work block
...
public:
    ...
    {
        // KMC: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    /** Amount of kmc spent by this transaction.
    ...
    /** Amount of kmc coming in to this transaction
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // KMC: get transaction coin age
...
public:
    ...
    // KMC: block signature - signed by coin base txout[0]'s owner
    ...
    // KMC: entropy bit for stake modifier if chosen by modifier
    ...
    // KMC: two types of block: proof-of-work or proof-of-stake
    ...
    // KMC: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // KMC: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // KMC: trust score of block chain
    int nHeight;
    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // KMC: block index flags
    enum  
    {
