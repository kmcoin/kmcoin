...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send shares to a kmc address"));
    ...
    aboutAction->setToolTip(tr("Show information about kmc"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for kmc"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/peershares"), tr("Show/Hide &kmc"), this);
    toggleHideAction->setToolTip(tr("Show or hide the kmc window"));
    ...
    exportPeercoinKeysAction = new QAction(QIcon(":/icons/export"), tr("&Export KMC keys"), this);
    exportPeercoinKeysAction->setToolTip(tr("Export the KMC keys associated with the kmc addresses to KMC via RPC"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("kmc client"));
    ...
    notificator = new Notificator(tr("kmc-qt"), trayIcon);
}
...
void BitcoinGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
    ...
    {
        // Click on system tray icon triggers "show/hide kmc"
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to kmc network", "", count));
}
