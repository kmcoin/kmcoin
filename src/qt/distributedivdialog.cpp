...
const char* DistributeDivDialog::columnHeadings[] = {
    "kmc Address", "Shares", "KMC Address", "Dividend"
};
...
bool DistributeDivDialog::ConfirmDistribution()
{
    ...
    {
        QMessageBox::critical(this, "Error", QString("Unable to get KMC balance: %1").arg(error.what()));
        return false;
    }
    QString sQuestion = QString("%1 KMCS will be sent to %2 addresses in %3 transaction(s).\nYour current KMC balance is %4.\n\nAre you sure?").arg(
