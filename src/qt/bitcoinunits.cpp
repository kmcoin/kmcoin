...
QString BitcoinUnits::name(int unit)
{
    ...
    case mBTC: return QString("m-KMC");
    case uBTC: return QString::fromUtf8("μ-KMC");
...
QString BitcoinUnits::description(int unit)
{
    ...
    {
    case BTC: return QString("KMC");
    case mBTC: return QString("Milli-KMC (1 / 1,000)");
    case uBTC: return QString("Micro-KMC (1 / 1,000,000)");
    default: return QString("???");
    }
}
