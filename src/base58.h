...
// Copyright (c) 2013-2014 kmc Developers
...
public:
    enum
    {
        PUBKEY_ADDRESS = 46,  // kmc addresses begin with 'V'
        SCRIPT_ADDRESS = 53, // kmc script addresses begin with 'Y'
...
public:
    enum
    {
        //PUBKEY_ADDRESS = 55,  // KMC: addresses begin with 'P'
        //SCRIPT_ADDRESS = 117, // KMC: addresses begin with 'p'
