...
//       ( 100000, uint256("0xa17dba3013fa6eede33707840a1e888e70fc335bb73407bb4ee2c5e05e1dee6b"))
    ...
    // kmc: synchronized checkpoint (centrally broadcasted)
    ...
    // kmc: get last synchronized checkpoint
    ...
    // kmc: only descendant of current sync-checkpoint is allowed
    ...
    // kmc: reset synchronized checkpoint to last hardened checkpoint
...
// kmc: sync-checkpoint master key
...
// kmc: verify signature of sync-checkpoint message
...
// kmc: process synchronized checkpoint
